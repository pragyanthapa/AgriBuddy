  ...
  return (
    <div className="min-h-screen bg-gray-900 text-gray-100">
      ...
      <main className="container mx-auto px-4 py-8">
        <h1 className="text-3xl font-bold mb-8">Welcome, Farmer John</h1>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <Card className="bg-gray-800">
            ...
            <CardFooter>
              <Link href="/farmers/dashboard/market-sentiment">
      ...
      <footer className="w-full py-6 mt-12 border-t border-gray-800">
        <div className="container mx-auto px-4 md:px-6 flex flex-col gap-2 sm:flex-row items-center">
          <p className="text-xs text-gray-400">© 2024 ContractFarm. All rights reserved.</p>
